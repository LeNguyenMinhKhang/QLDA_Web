        ...
        <div className='container mx-auto px-4'>
            <div className='flex flex-col md:flex-row justify-between items-center'>
                <div className='mb-5 md:mb-0'>
                    <h2 className='text-xl font-bold text-[#6CDF62]'> <span className='text-black'>Talent</span> Hub</h2>
                    <p className='text-sm'>2025 Talenhub</p>
                </div>
                <div className='flex space-x-4 mt-4 md:mt-0'>
                    <a href="https://facebook.com" className='hover:text-gray-400 text-[#6CDF62]' aria-label='Facebook'>
                    ...
                    <a href="https://twitter.com" className='hover:text-gray-400 text-[#6CDF62]' aria-label='Twitter'>
                    ...
                    <a href="https://instagram.com" className='hover:text-gray-400 text-[#6CDF62]' aria-label='Instagram'> 
